...
app.use(cors({
  origin: 'https://64b064a165181e4d0277ea8e--joyful-caramel-b9e74c.netlify.app',
  credentials: true, // Enable credentials (cookies, authorization headers, etc)
}));
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://64b064a165181e4d0277ea8e--joyful-caramel-b9e74c.netlify.app');
